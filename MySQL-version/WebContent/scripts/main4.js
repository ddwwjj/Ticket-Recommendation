(function() {
    ...
    function init() {
    	...
    	$('signon').addEventListener('click', function(){
    		var login_form = $('li-form');
    		var logon_form = $('lo-form');
    		showElement(login_form);
    		hideElement(logon_form);
    		
    	});
    	$('signin').addEventListener('click', function() {
    		var login_form = $('li-form');
    		var logon_form = $('lo-form');
    		showElement(logon_form);
    		hideElement(login_form);
    	});
    	$('login-btn').addEventListener('click', login);
    	$('logon-btn').addEventListener('click', logon);
 ...
 // -----------------------------------
	...
	// 
	function logon() {
		var username = $('rg-username').value;
		var password = $('rg-password').value;
		var firstname = $('rg-firstname').value;
		var lastname = $('rg-lastname').value;
		password = md5(username + md5(password));
	...
	function showLogonError() {
		$('logon-error').innerHTML = 'Logon failed, try again later.';
	}

	function clearLogonError() {
		$('logon-error').innerHTML = '';
	}
